		...
		jint flags, jstring skus)
{
	if (flags)
	{
		...
		std::string price = value["price"].GetString();
		std::string sku = value["sku"].GetString();
		std::string title = value["title"].GetString();
		std::string type = value["type"].GetString();
		std::string priceAmountMicros = value["priceAmountMicros"].GetString();
		std::string priceCurrencyCode = value["priceCurrencyCode"].GetString();
		std::string googleOrder = value["googleOrder"].GetString();
		std::string signature = value["signature"].GetString();
		std::string purchaseOriginalData = value["purchaseOriginalData"].GetString();
